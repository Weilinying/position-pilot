...
PositionPilot 自身的 Agent Orchestration 尚未确定，候选包括 Native Tool Calling 与 LangGraph。LLM Provider、Market Data Provider、News Provider 和 Financial Data Provider 也尚未确定。
