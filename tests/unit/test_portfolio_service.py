...
class FakeUnitOfWork:
    ...
    def list_transactions(self, user_id: UUID) -> list[Transaction]:
        return list(self._store.transactions[user_id])
...
def test_records_transactions_with_lock_sequence_and_derived_amount() -> None:
    """写入应锁定 User、连续编号且只持久化派生 amount。"""
